...
{
	auto keyboard = TextureManager::get("keyboard");
...
sf::Sprite* KeysManager::getKeySprite(const Keys & key)
{
...
void KeysManager::cutRegularKeys(const int & Left, const int & Top, const size_t & count)
{
